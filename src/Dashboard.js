                                                ...
                                                nav.requests.map((request, index) => {
                                                    return (
                                                        <>
                                                            ...
                                                            <NavLink onClick={handleSlideBarMobile} exact activeClassName="dashboard-active-sub-class" to={'/request/' + request.id}  className="dashboard-nav-link drop-down-link">
